<?php  //[STAMP] b9c313383a027e7ef16d55689c238e8a
...
trait AcceptanceTesterActions
{
     ...
     *
     *
     * @see \Helper\Acceptance::goToVideoPage()
     */
    public function goToVideoPage($I) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('goToVideoPage', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Acceptance::search()
     */
    public function search($I, string $text) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('search', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Acceptance::deleteFilesIfExists()
     */
    public function deleteFilesIfExists($listOfFiles) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('deleteFilesIfExists', func_get_args()));
    }
}
